export const MatchCoderInfo = {
    projectInfo: {
        title: 'projects.match_coder.title',
        fisrtDescription: 'projects.match_coder.fisrtDescription',
        projectDate: 'projects.match_coder.projectDate',
        urlBanner: './img/projects/banner/project_gallery_banner_9.png',
        problemDescription: {
        ...
        exampleDescription: {
            ...
            imageUrl: './img/projects/exemple/project_05.png',
        },
        finalDescription: {
