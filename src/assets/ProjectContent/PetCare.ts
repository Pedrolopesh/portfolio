export const PetCaretInfo = {
    projectInfo: {
        title: 'projects.pet_care.title',
        fisrtDescription: 'projects.pet_care.fisrtDescription',
        projectDate: 'projects.pet_care.projectDate',
        urlBanner: './img/projects/banner/project_gallery_banner_11.png',
        problemDescription: {
        ...
        exampleDescription: {
            ...
            imageUrl: './img/projects/exemple/project_06.png',
        },
        finalDescription: {
