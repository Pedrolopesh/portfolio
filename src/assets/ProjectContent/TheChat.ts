export const TheChatInfo = {
    projectInfo: {
        title: 'projects.the_chat.title',
        fisrtDescription: 'projects.the_chat.fisrtDescription',
        projectDate: 'projects.the_chat.projectDate',
        urlBanner: './img/projects/banner/project_gallery_banner_2.png',
        problemDescription: {
        ...
        exampleDescription: {
            ...
            imageUrl: './img/projects/exemple/the_chat_web_site.png',
        },
        finalDescription: {
