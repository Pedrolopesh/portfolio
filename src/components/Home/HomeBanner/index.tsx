...
import { ContainerContentBanner, ContainerHomeBanner, ContainerLogo, ContentHomeBannerBlock } from "./styles";
                    ...
                    <div className={style.ContentHomeBannerBlock}>
                        ...
                        <div>
                            <div className={style.ContainerTypingTitle}>
                                ...
                                <Typewriter
                                    words={[`${t('homeBanner.title_typing_0')}`, `${t('homeBanner.title_typing_1')}`, `${t('homeBanner.title_typing_2')}`, `${t('homeBanner.title_typing_3')}`]}
                                    loop={5}
                                    cursor
                                    cursorStyle='|'
                                    typeSpeed={70}
