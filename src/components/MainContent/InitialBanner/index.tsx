    ...
    return (
        <>
            ...
            <Container>
                 ...
                 <ContainerRigth>
                    <ContainerAssetsAnimation> 
                        <CubeAnimation src='/img/cubeAsset.png' alt="Cube Animation asset" />
                        <ComputerAnimation src='/img/computer.png' alt="Computer Animation" />
                    </ContainerAssetsAnimation>
                    <BgWhite src='/img/home-bg.png'  alt="Home White BG" />
                 </ContainerRigth>
            </Container>
